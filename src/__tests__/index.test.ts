...
import { instanceOf } from "alliage-di/dependencies";
...
import { Params } from "alliage-webserver/http";
...
jest.mock("alliage-di/dependencies", () => {
  const module = jest.requireActual("alliage-di/dependencies");
  return {
    ...(module as any),
